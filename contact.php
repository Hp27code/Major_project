        ...
        <div class="row" style="margin-top: 50px;">
            ...
            <div class="col-md-4 py-3 py-md-0">
                <div class="card">
                    ...
                    <h6>mobilestore4u@gmail.com</h6>
                </div>
            </div>
            <div class="col-md-4 py-3 py-md-0">
                <div class="card">
                    <i class="fas fa-location-dot"> Address</i>
                    <h6>jalandher ,punjab ,india</h6>
                </div>
            </div>
        </div>
...
<div class="w-50 m-auto" id="side1">
   <label> NAME:</label> 
      <input type='text' name='name' autocomplete="off" class="form-control"><br>
     <label> EMAIL:</label> 
      <input type='text' name='email' autocomplete="off" class="form-control"><br>
     <label> PHONE:</label> 
      <input type='number' name='phone' autocomplete="off" class="form-control"><br>
     <label> MESSAGE:</label> 
      <textarea type='text' name='message' autocomplete="off" class="form-control"></textarea>
